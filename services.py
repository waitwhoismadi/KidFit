    ...
    def geocode_address(self, address: str, city: str = "Astana", country: str = "Kazakhstan") -> Optional[Tuple[float, float]]:
        ...
        try:
            ...
            params = {
                ...
                'format': 'json',
                'limit': 1,
                'countrycodes': 'kz',  # Restrict to Kazakhstan
                'addressdetails': 1
            }
            
            headers = {
                'User-Agent': 'EduPlatform-Astana/1.0'  # Required by Nominatim
            }
            ...
            if data and len(data) > 0:
                ...
                # Validate coordinates are in/near Astana
                # Astana/Nur-Sultan coordinates: roughly 51.1605° N, 71.4704° E
...
# Astana landmark coordinates for reference
ASTANA_LANDMARKS = {
...
def get_astana_bounds():
    """Get map bounds for Astana city"""
    return {
        'north': 51.25,
        'south': 50.95,
        'east': 71.65,
